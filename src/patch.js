...
// onclick
// 3rd party
const patch = ({parent, element, oldVirtualNode, newVirtualNode}) => {
...
const patchMatchingChildren = ({element, oldVirtualNode, newVirtualNode}) => {
...
const removeExcessChildren = ({element, oldVirtualNode, newVirtualNode}) => {
...
const updateElementData = ({element, oldVirtualNode, newVirtualNode}) => {
...
const createTagElement = virtualNode => {
